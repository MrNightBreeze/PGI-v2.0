...
public class Perfil extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.ok_btn)
        {
            User user= new User(Main2Activity.userid,Main2Activity.first_name, desporto.isChecked(), entretenimento.isChecked(), arte.isChecked(), estudar.isChecked(), restaurantes.isChecked());
